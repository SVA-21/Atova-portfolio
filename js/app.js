(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) {
            ...
            window.addEventListener("resize", (() => {
                if (window.innerWidth > 991.98) document.documentElement.classList.remove("menu-open");
            }));
        }
    }
    function menuClose() {
    ...
    function initSliders() {
        if (document.querySelector(".courses__slider")) new core(".courses__slider", {
            ...
            loop: true,
            navigation: {
                prevEl: ".courses__arrow_prev",
                nextEl: ".courses__arrow_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
        ...
        if (document.querySelector(".slider-partner__slider")) new core(".slider-partner__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1.05,
            ...
            parallax: true,
            pagination: {
                el: ".slider-partner__pagination",
                clickable: true
            },
            loop: true,
            navigation: {
                prevEl: ".slider-partner__arrow_prev",
                nextEl: ".slider-partner__arrow_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            let itemMenu = document.querySelector(".menu__item_home");
            const targetElement = e.target;
            if (targetElement.classList.contains("menu__item_home")) itemMenu.classList.toggle("_active");
            if (!targetElement.closest(".menu__item_home")) itemMenu.classList.remove("_active");
            let selectList = document.querySelector(".select-registration__list");
            let selectInput = document.querySelector(".select-registration__input");
            let selectBodyInput = document.querySelector(".select-registration__body-input");
            if (targetElement.classList.contains("select-registration__body-input")) {
                selectList.classList.toggle("_active");
                selectBodyInput.classList.toggle("_active");
            } else if (!targetElement.closest(".select-registration__body-input")) {
                selectList.classList.remove("_active");
                selectBodyInput.classList.remove("_active");
            }
            let selectItems = document.querySelectorAll(".select-registration__item");
            for (let item of selectItems) if (targetElement == item) selectInput.value = item.innerHTML;
        }
        function iconSearchHidden() {
            let btn = document.querySelector(".form__icon");
        ...
        function numberAnimation() {
            for (let i of document.querySelectorAll(".number")) {
                ...
                let end = +i.dataset.max;
                if (document.querySelector(".main-block__statistic").classList.contains("_watcher-view") || true) {
                    let interval = setInterval((function() {
                        i.innerHTML = start += 10;
                        if (start == end) {
                            clearInterval(interval);
                            if (i.classList.contains("number_plus")) i.innerHTML += "+"; else {
                                let arr = Array.from(i.innerHTML);
                                if (arr.length >= 5) {
                                    let k = `${arr[1]},`;
                                    arr[1] = k;
                                } else {
